...
import {formatSupportedCPU} from "@/utils/downloads";
                            ...
                            <Row gap="l" fillWidth>
                                <Card radius="l-4" direction="column" border="brand-strong" horizontal="center">
                                    ...
                                    <Row horizontal="center" padding="m" gap="l">
                                        <DownloadButton platform="win" cpu="x64"/>
                                    </Row>
                                </Card>
                                <Card radius="l-4" direction="column" border="brand-strong" horizontal="center">
                                    <Row fillWidth paddingX="20" paddingY="12" gap="xs" horizontal="center">
                                    ...
                                    <Line background="neutral-alpha-medium"/>
                                    <Row horizontal="center" padding="m" gap="l">
                                        <DownloadButton platform="mac" cpu="arm64"
                                ...
                                <Card radius="l-4" direction="column" border="brand-strong">
                                    <Row fillWidth paddingX="20" paddingY="12" gap="xs">
                                        ...
                                        <Column vertical="center">
                                            ...
                                            <Line background="neutral-alpha-medium"/>
                                            <Text onBackground="neutral-weak" variant="body-default-xl">
                                                We have tarballs, including a standard Linux executable with all of the dependencies needed to run it included.<br/>
                                                Additionally, we offer AppImages, of both architectures, for those who wish to use it.
                                            </Text>
                                        </Column>
                                    </Row>
                                    <Line background="neutral-alpha-medium"/>
                                    <Column gap="s" padding="m">
                                        <Row horizontal="center" gap="m">
                                            <DownloadButton platform="linux" cpu="x64"
                                                            getLabel={(_, cpu, ___) => `Tarball: ${formatSupportedCPU(cpu)}`}/>
                                            <DownloadButton platform="linux" cpu="arm64"
                                                            getLabel={(_, cpu, ___) => `Tarball: ${formatSupportedCPU(cpu)}`}/>
                                        </Row>
                                        <Row horizontal="center" gap="m">
                                            <DownloadButton platform="linuxai" cpu="x64"
                                                            getLabel={(_, cpu, ___) => `AppImage: ${formatSupportedCPU(cpu)}`}/>
                                            <DownloadButton platform="linuxai" cpu="arm64"
                                                            getLabel={(_, cpu, ___) => `AppImage: ${formatSupportedCPU(cpu)}`}/>
                                        </Row>
                                    </Column>
                                </Card>
